...
return gap;
  ...
  return (<div >
   <div className="backimg">
       ...
       <nav className="profileimg"><img src={partnerimg} className="user-profileimg"></img></nav>
        <Link to="/mypage"><nav className="profileimg"><img src={myimg} className="user-profileimg" onClick={mypagelink}></img></nav></Link>
        </div>
